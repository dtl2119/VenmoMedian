...
#    output_path = "/insight/idschallenge/insight_testsuite/tests/test-1-venmo-trans/venmo_output/output.txt"
#    input_path = "/insight/idschallenge/insight_testsuite/tests/test-1-venmo-trans/venmo_input/venmo-trans.txt"
#    output_path = "tests/test-1-venmo-trans/venmo_output/output.txt"
#    input_path = "tests/test-1-venmo-trans/venmo_input/venmo-trans.txt"
    ...
    #with open("../data-gen/test-trans.txt") as f:
        for line in f:
            ...
            # But rolling median still same as before
